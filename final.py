        ...
        try:
            ...
            if margin_values:
                ...
                if valid_margins:
                    ...
                    try:
                        asins_ws.update_cell(row, 2, first_margin)
                        logger.info("✅ Wrote Net Profit Margin %s for ASIN %s at row %d, column B", first_margin, asin, row)
                    except Exception as e:
                                ...
                                if warning_icon_exists:
                                    ...
                                    try:
                                        ...
                                        if margin_values:
                                            ...
                                            # Write the first margin value to Google Sheet
                                            first_margin = margin_values[0]
                                            asins_ws.update_cell(row, 2, first_margin)
                                            logger.info("✅ Wrote margin after select: %s", margin_values)
